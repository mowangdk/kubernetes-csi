...
// This individual entrypoint is intentionally retained to validate standalone
// compatibility against the same assembled packages used by the AIO binary.
...
func main() {
	...
	// Share configuration with AIO, preserving the individual unprefixed CLI.
	...
	// Adapt the shared configuration to the upstream startup logic's pointers.
