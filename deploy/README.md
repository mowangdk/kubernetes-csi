...
This directory implements the local CSI hostpath deployment described above.
The manifests are based on the Kubernetes 1.27 deployment from
https://github.com/kubernetes-csi/csi-driver-host-path/blob/master/deploy/kubernetes-1.27/.
